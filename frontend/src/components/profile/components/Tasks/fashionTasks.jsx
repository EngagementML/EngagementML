...
export class FashionTasks extends Component {
  ...
  render() {
    ...
    const mockD = [
      ...
      // Hours
      [{"Day_Time_Post": "Morning (8Am-12PM)", "%_Post_Day": 36.0, "Likes_Rate_Daytime%": 43.0, "Engagement_Rate_day": 1.1431389393}, {"Day_Time_Post": "Noon (12-4PM)", "%_Post_Day": 25.0, "Likes_Rate_Daytime%": 29.0, "Engagement_Rate_day": 1.0247284839}, {"Day_Time_Post": "Eve (4PM-8PM)", "%_Post_Day": 18.0, "Likes_Rate_Daytime%": 12.0, "Engagement_Rate_day": 0.8075945874}, {"Day_Time_Post": "Early Morning (4AM-8Am)", "%_Post_Day": 10.0, "Likes_Rate_Daytime%": 9.0, "Engagement_Rate_day": 1.193240472}, {"Day_Time_Post": "Late Night (12Am-4AM)", "%_Post_Day": 6.0, "Likes_Rate_Daytime%": 3.0, "Engagement_Rate_day": 0.6036288703}, {"Day_Time_Post": "Night (8PM-12AM)", "%_Post_Day": 6.0, "Likes_Rate_Daytime%": 2.0, "Engagement_Rate_day": 2.148222022}],
